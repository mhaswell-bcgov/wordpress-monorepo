...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const mobileNavIconText = document.querySelector(".dswp-nav-mobile-menu-icon-text");
  const mobileNavTopBar = document.querySelector(".dswp-nav-mobile-menu-top-bar");
  const mobileNavMiddleBar = document.querySelector(".dswp-nav-mobile-menu-middle-bar");
  const mobileNavBottomBar = document.querySelector(".dswp-nav-mobile-menu-bottom-bar");
