...
function enqueue_auto_anchor_heading_script() {
    $script_path = plugin_dir_path( __FILE__ ) . 'dist/auto-add-anchor-heading.js';
    $script_url = plugin_dir_url( __FILE__ ) . 'dist/auto-add-anchor-heading.js';
    
    // This file is automatically generated and includes all necessary dependencies
    $asset_file = include(plugin_dir_path(__FILE__) . 'dist/auto-add-anchor-heading.asset.php');
...
add_action('enqueue_block_editor_assets', 'enqueue_auto_anchor_heading_script');
